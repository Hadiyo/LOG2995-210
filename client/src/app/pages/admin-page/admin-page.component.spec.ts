...
describe('AdminPageComponent', () => {
  ...
  let mapServiceSpy: jasmine.SpyObj<MapApiService>;
  ...
  beforeEach(async () => {
    mapServiceSpy = jasmine.createSpyObj<MapApiService>('MapService', ['getAllMaps', 'deleteMap', 'updateMapVisibility']);
    ...
    await TestBed.configureTestingModule({
      ...
      providers: [
        provideRouter([]),
        { provide: MapApiService, useValue: mapServiceSpy },
