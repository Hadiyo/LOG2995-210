...
export function buildWaitingRoomVirtualPlayer(room: WaitingRoom, profile: VirtualPlayerProfile): MatchLobbyPlayer {
    ...
    return {
        ...
        avatarId,
        isOrganizer: false,
        speed: CHARACTER_BASE_ATTRIBUTES.rapidite + (healthBoosted ? 0 : CHARACTER_PLUS_TWO_VALUE),
        maxHealth: CHARACTER_BASE_ATTRIBUTES.vie + (healthBoosted ? CHARACTER_PLUS_TWO_VALUE : 0),
        baseAttack: CHARACTER_BASE_ATTRIBUTES.attaque,
